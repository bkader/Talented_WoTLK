...
do
    ...
    function Talented.DrawLine(...)
        ...
        return DrawVerticalLine(...) or DrawHorizontalLine(...) or DrawHorizontalVerticalLine(...) or
...
do
    ...
    local function TabFrame_OnEnter(self)
        ...
        if not info.pet and not self:GetChecked() then
            GameTooltip:AddLine(
                L["Right-click to activate this spec"],
                GREEN_FONT_COLOR.r,
                GREEN_FONT_COLOR.g,
                GREEN_FONT_COLOR.b,
                1
    ...
    local function Tabs_UpdateCheck(self, template)
        if not template or not Talented.alternates then
            return
        end
